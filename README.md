[![Build Status](https://travis-ci.org/terikon/cordova-plugin-photo-library-ios.svg?branch=master)](https://travis-ci.org/terikon/cordova-plugin-photo-library-ios)
...
Currently Android code is pretty stable, iOS has few stability [issues](https://github.com/terikon/cordova-plugin-photo-library-ios/issues).
...
# Install
    ...
    cordova plugin add cordova-plugin-photo-library-ios --variable PHOTO_LIBRARY_USAGE_DESCRIPTION="To choose photos" --save
...
As mentioned [here](https://github.com/terikon/cordova-plugin-photo-library-ios/issues/15) by dnmd, cdvphotolibrary urls should bypass sanitization to work.
...
TypeScript definitions are provided in [PhotoLibrary.d.ts](https://github.com/terikon/cordova-plugin-photo-library-ios/blob/master/PhotoLibrary.d.ts)

# Tests

The library includes tests in [tests](https://github.com/terikon/cordova-plugin-photo-library-ios/tree/master/tests) folder. All tests are in
[tests.js](https://github.com/terikon/cordova-plugin-photo-library-ios/blob/master/tests/tests.js) file.
...
- [#38](https://github.com/terikon/cordova-plugin-photo-library-ios/issues/38) browser platform: saveImage and saveVideo should download file.
